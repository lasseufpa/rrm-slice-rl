...
class Buffer:
    dropped_packets = 0  # Accumulate the number of dropped packets
    ...
    def arrived_packets(self, num_packets_arrived: int) -> None:
        """
    ...
    def sent_packets(self, packets_available_to_sent: int) -> None:
        """
...
def main():
    ...
    for packets in arrived_packets:
        ue_buffer.arrived_packets(packets)
        print(
            ue_buffer.buffer,
            ",  Number of dropped packets: ",
            ue_buffer.dropped_packets,
        )
        ue_buffer.sent_packets(sent_packets)
