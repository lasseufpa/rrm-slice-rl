...
def plot_reward_ws_comparison(
    ...
    for attribute in data_index.keys():
        ...
        os.makedirs("./results", exist_ok=True)
        fig.savefig(
            "./results/agents_ws_comp_{}.pdf".format(obs_space),
            # bbox_inches="tight",
            pad_inches=0,
            format="pdf",
            dpi=1000,
...
def plot_cum_reward_ws_comparison(
    trial_number: int,
    agents: list,
    windows_sizes: list,
    obs_space: str,
    ...
    for attribute in data_index.keys():
        ...
        os.makedirs("./results", exist_ok=True)
        fig.savefig(
            "./results/agents_ws_comp_cumm_{}.pdf".format(obs_space),
            # bbox_inches="tight",
            pad_inches=0,
            format="pdf",
            dpi=1000,
